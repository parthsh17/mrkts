    ...
    <main className="min-h-screen bg-[#18181b] flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 px-5 py-3 border-2 border-white bg-white text-black font-black text-sm uppercase tracking-widest neo-shadow hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all duration-100 disabled:opacity-60 disabled:cursor-not-allowed disabled:translate-x-0 disabled:translate-y-0"
        >
          {loading ? (
        ...
        <p className="text-center text-white/20 text-[10px] mt-6 uppercase tracking-widest font-bold">
          No account needed · Demo mode active
        </p>
      </div>
